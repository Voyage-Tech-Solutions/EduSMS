-- ============================================================
-- OFFICE DASHBOARD - NEW TABLES ONLY (No Duplicates)
...
CREATE INDEX IF NOT EXISTS idx_notifications_log_recipient ON notifications_log(recipient_id);
